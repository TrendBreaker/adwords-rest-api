...
from adwords.errors import *
from adwords.helper import adwords_service, paged_request
from adwords.lock import release_googleadwords_lock
...
class Alert(models.Model):
    ...
    account = models.ForeignKey('adwords.Account', related_name='alerts')
...
class DailyAccountMetrics(models.Model):
    ...
    account = models.ForeignKey('adwords.Account', related_name='metrics')
...
class Campaign(models.Model):
    ...
    account = models.ForeignKey('adwords.Account', related_name='campaigns')
...
class DailyCampaignMetrics(models.Model):
    ...
    campaign = models.ForeignKey('adwords.Campaign', related_name='metrics')
    avg_cpc = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPC', null=True, blank=True)
    avg_cpm = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPM', null=True, blank=True)
    avg_position = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, help_text='Avg. position')
    clicks = models.IntegerField(help_text='Clicks', null=True, blank=True)
...
class AdGroup(models.Model):
    ...
    campaign = models.ForeignKey('adwords.Campaign', related_name='ad_groups')
...
class DailyAdGroupMetrics(models.Model):
    ...
    ad_group = models.ForeignKey('adwords.AdGroup', related_name='metrics')
    avg_cpc = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPC', null=True, blank=True)
    avg_cpm = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPM', null=True, blank=True)
    avg_position = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, help_text='Avg. position')
    clicks = models.IntegerField(help_text='Clicks', null=True, blank=True)
...
class Ad(models.Model):
    ...
    ad_group = models.ForeignKey('adwords.AdGroup', related_name='ads')
...
class DailyAdMetrics(models.Model):
    ad = models.ForeignKey('adwords.Ad', related_name='metrics')
    avg_cpc = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPC', null=True, blank=True)
    avg_cpm = MoneyField(max_digits=12, decimal_places=2, default=0, help_text='Avg. CPM', null=True, blank=True)
    avg_position = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True, help_text='Avg. position')
    clicks = models.IntegerField(help_text='Clicks', null=True, blank=True)
